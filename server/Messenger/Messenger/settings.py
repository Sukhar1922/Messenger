...
SECRET_KEY = 'django-insecure-2j)&&(7vu#wgp-2j0m%uik@^v$f98v*l%d1nyz^te!kb)8^o^#'
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Messenger API',                               # Название API
    'DESCRIPTION': 'API для работы с ядром мессенджера',  # Описание API
